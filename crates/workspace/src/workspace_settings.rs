...
pub struct WorkspaceSettings {
    ...
    pub notify_task_completion: bool,
    pub notify_agent_attention: bool,
    pub notify_while_app_visible: bool,
...
impl Settings for WorkspaceSettings {
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        Self {
            ...
            background_execution: workspace.background_execution.unwrap(),
            notify_task_completion: workspace.notify_task_completion.unwrap(),
            notify_agent_attention: workspace.notify_agent_attention.unwrap(),
            notify_while_app_visible: workspace.notify_while_app_visible.unwrap(),
