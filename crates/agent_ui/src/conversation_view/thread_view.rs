...
use gpui::{List, MouseButton, Stateful, TaskExt};
...
impl ThreadView {
    ...
    fn render_thread_controls(
        ...
        let export_button = is_thread_bottom.then(|| {
            IconButton::new("export-conversation", IconName::Download)
                .icon_size(IconSize::Small)
                .icon_color(Color::Muted)
        ...
        h_flex()
                ...
                |this| {
                    this.child(
                        h_flex()
                            .px_1()
                            .gap_1()
                            .when_some(local_usage_label, |this, label| {
            ...
            .when_some(export_button, |this, button| this.child(button))
