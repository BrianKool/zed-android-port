...
impl TerminalView {
    ...
    pub fn deploy_context_menu(
        ...
        let shows_workspace_actions = self.shows_workspace_actions();
        let context_menu = ContextMenu::build(window, cx, move |menu, _, _| {
            let menu = menu
                .context(focus_handle.clone())
                .when(shows_workspace_actions, |menu| {
                ...
                .when(!is_embedded, |menu| menu.action("Clear", Box::new(Clear)));
            ...
            menu.when(assistant_enabled && !is_embedded, |menu| {
                menu.separator()
                    .action("Inline Assist", Box::new(InlineAssist::default()))
                    .when(has_selection && shows_workspace_actions, |menu| {
